...
class TreasureHuntNoRecursionTest extends GroovyTestCase {
    void testFindsResult() {
        ...
        def th = new TreasureHuntNoRecursion();
    ...
    void testFindsResult2() {
        ...
        def service = new TreasureHuntNoRecursion();

        //when
        TreasureHuntResult result = service.findTreasure(input);
    ...
    void testNoTreasury1() {
        ...
        //when
        TreasureHuntResult result = service.findTreasure(input as int[][], 4, 2);
    ...
    void testNoTreasury2() {
        ...
        //when
        TreasureHuntResult result = service.findTreasure(input as int[][]);
    ...
    void testThrowsExceptionForNegativeStartX() {
        ...
        def msg = shouldFail(IllegalStateException) {
            //when
            service.findTreasure(input as int[][], -1, 3);
        }
